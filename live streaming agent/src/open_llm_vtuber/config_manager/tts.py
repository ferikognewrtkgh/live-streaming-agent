...
class GPTSoVITSConfig(I18nMixin):
    ...
    stream_api_url: Optional[str] = Field(None, alias="stream_api_url")
    default_emotion: str = Field("default", alias="default_emotion")
    speed: float = Field(1.0, alias="speed")
    first: bool = Field(True, alias="first")
    request_timeout: float = Field(360.0, alias="request_timeout")
    stream_read_timeout: float = Field(30.0, alias="stream_read_timeout")
